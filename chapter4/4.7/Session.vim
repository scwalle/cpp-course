...
tnoremap  
nnoremap  mw :call tinykeymap#Call('windows')
...
set runtimepath=
set runtimepath+=~/.vim
set runtimepath+=~/.vim/plugged/vim-jqplay
set runtimepath+=~/.vim/plugged/fzf
set runtimepath+=~/.vim/plugged/forth.vim
...
set runtimepath+=~/.vim/plugged/ReplaceWithRegister
...
set runtimepath+=~/.vim/plugged/vim-pencil
set runtimepath+=~/.vim/plugged/vim-arpeggio
set runtimepath+=~/.vim/plugged/vim-lsp
set runtimepath+=~/.vim/plugged/vim-lsp-settings
set runtimepath+=~/.vim/plugged/vim-javascript
set runtimepath+=~/.vim/plugged/tinykeymap_vim
set runtimepath+=/usr/share/vim/vimfiles
set runtimepath+=/usr/share/vim/vim90
set runtimepath+=/usr/share/vim/vimfiles/after
set runtimepath+=~/.vim/plugged/vim-arpeggio/after
set runtimepath+=~/.vim/plugged/vim-javascript/after
set runtimepath+=~/.vim/after
set shiftwidth=4
set smartcase
set statusline=%1*\ %n\ %*%5*%{&ff}%*%3*%y%*%4*\ %<%F%*%2*%m%*%1*%=%5l%*%2*/%L%*%1*%4v\ %*%2*0x%04B\ %*
set tabstop=4
set ttimeoutlen=0
set wildmenu
set window=4720062680554012672
let s:so_save = &g:so | let s:siso_save = &g:siso | setg so=0 siso=0 | setl so=-1 siso=-1
let v:this_session=expand("<sfile>:p")
silent only
silent tabonly
cd ~/Documents/cpp-course/chapter4/4.7
...
argglobal
1argu
terminal ++curwin ++cols=79 ++rows=36 
...
silent! normal! zE
let &fdl = &fdl
let s:l = 10 - ((0 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 10
